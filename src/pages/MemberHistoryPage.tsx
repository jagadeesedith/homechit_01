...
import { Search, User, DollarSign, TrendingUp, Upload, FileText, Users, Calendar } from 'lucide-react';
      ...
      <div className="mb-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-black text-gray-900 tracking-tight">Member History</h1>
              <p className="text-gray-600 text-sm font-medium">Track individual member payment records</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-lg">
          <div className="mb-4">
            <h3 className="text-lg font-bold text-gray-900 mb-2">Select Member</h3>
            <p className="text-sm text-gray-600">Search by member ID or name to view detailed history</p>
          </div>
          ...
          {searchQuery && !selectedMemberId && (
            <div className="mt-3 border border-gray-200 rounded-xl max-h-64 overflow-y-auto bg-white shadow-lg">
              {filteredMembers.length === 0 ? (
                ...
                filteredMembers.map(m => (
                  <button
                    ...
                    className="w-full text-left px-4 py-3 text-sm text-gray-700 hover:bg-teal-50 hover:text-teal-700 border-b border-gray-100 last:border-0 transition-all duration-150 flex items-center gap-3"
                  >
            ...
            <div className="bg-gradient-to-br from-teal-500 to-cyan-600 rounded-2xl p-6 shadow-xl text-white">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-teal-100 text-sm font-medium">ID: {member.id}</p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/10 backdrop-blur rounded-xl p-3">
                  <p className="text-teal-100 text-xs font-medium">Phone</p>
                  <p className="text-white font-semibold text-sm mt-1">{member.phone}</p>
                </div>
                <div className="bg-white/10 backdrop-blur rounded-xl p-3">
                  <p className="text-teal-100 text-xs font-medium">Status</p>
                  <p className="text-white font-semibold text-sm mt-1">Active</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-2xl font-black text-gray-900">{formatINR(member.balance)}</span>
                </div>
                <p className="text-sm font-bold text-gray-700">Current Balance</p>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-2xl font-black text-gray-900">{monthsActive}</span>
                </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-2xl font-black text-purple-900">{formatINR(totalPaidToDate)}</span>
                </div>
                <p className="text-sm font-bold text-gray-700">Total Paid to Date</p>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-xl overflow-hidden">
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">Payment Ledger</h3>
                    <p className="text-sm text-gray-600">Complete payment history for {member.name}</p>
                  </div>
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 sticky top-0 z-10">
                    <tr className="border-b border-gray-200">
                      <th className="text-left text-xs font-bold text-gray-700 uppercase tracking-wider px-6 py-4">Month</th>
                      <th className="text-right text-xs font-bold text-gray-700 uppercase tracking-wider px-6 py-4">Last Balance</th>
                      ...
                      <th className="text-right text-xs font-bold text-gray-700 uppercase tracking-wider px-6 py-4">New Balance</th>
                    </tr>
                  </thead>
                    ...
                    {payments.length === 0 ? (
                      <tr>
                        <td colSpan={7} className="px-6 py-12 text-center">
                          ...
                          <p className="text-gray-400 text-sm mt-1">This member hasn't made any payments yet</p>
                        </td>
                      </tr>
                    ) : (
